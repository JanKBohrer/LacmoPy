...
#    ibreak = 0
    ...
    for i in range(0,no_SIPs):
        if(math.log(masses[i])>math.log(m_kernel_low)):
            mass_ind[i]= math.floor( (math.log(masses[i])-math.log(m_kernel_low))/math.log(eta_indize) + 0.5 )
...
#%% AON Method with Algo from Unterstrasser NEW with tabulated kernel
