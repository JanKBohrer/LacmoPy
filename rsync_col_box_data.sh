...
source_dir="bohrer@gauss5:/vols/fs1/work/bohrer/sim_data_col_box_model5/${dist}/${init}/eta_${eta}_${thresh}/results/"
destination_dir="/home/jdesk/sim_data_col_box_model5/${dist}/${init}/eta_${eta}_${thresh}/results/"
