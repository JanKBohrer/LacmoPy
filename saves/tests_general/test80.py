...
if dist == "expo":
    ...
    print(f"DNC0 = {DNC0:.3e}", "LWC0 =", LWC0, "m_mean = ", m_mean)
...
xi = np.load( ensemble_dir + f"xis_seed_{seed}.npy")

R = np.load( ensemble_dir + f"radii_seed_{seed}.npy")

import matplotlib.pyplot as plt
fig, ax = plt.subplots(figsize=(10,8))
ax.loglog(R, xi,"x")
ax.grid(which = "both")
ax.set_yticks( np.logspace(-1,8,10) )
